...
def normalize_processor_row(raw: dict[str, Any] | Any) -> dict[str, Any]:
    ...
    out = {
        ...
        "event_flag": src.get("event_flag", False),
        "event_types": src.get("event_types", ""),
        "event_dates": src.get("event_dates", ""),
        "reject_stage_candidate": src.get("reject_stage_candidate", ""),
        ...
        "linked_call_cost_to_put_credit": src.get("linked_call_cost_to_put_credit", None),
        "linked_call_upside_lift": src.get("linked_call_upside_lift", None),
        "linked_call_upside_lift_to_call_cost": src.get("linked_call_upside_lift_to_call_cost", None),
        "linked_call_upside_lift_to_put_credit": src.get("linked_call_upside_lift_to_put_credit", None),
        "linked_call_premium_funding_score": src.get("linked_call_premium_funding_score", None),
