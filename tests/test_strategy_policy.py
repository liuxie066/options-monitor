...
def test_strategy_resolution_uses_yield_enhancement_mode_for_short_put() -> None:
    position = {
        "symbol": "NVDA",
        "option_type": "put",
        "side": "short",
...
def test_strategy_resolution_defaults_legacy_yield_enhancement_to_return_first() -> None:
    position = {
        "symbol": "NVDA",
        "option_type": "put",
        "side": "short",
...
def test_sell_put_strategy_semantics_matrix() -> None:
    ...
    assert return_first.yield_enhancement_mode == YIELD_ENHANCEMENT_INCOME_UPSIDE_MODE
    assert return_first.yield_enhancement_requires_rv is False
    assert return_first.yield_enhancement_uses_short_vol_gate is False
...
def test_yield_enhancement_mode_helpers_are_policy_owned() -> None:
    assert yield_enhancement_mode_uses_short_vol(YIELD_ENHANCEMENT_VOL_CONVEXITY_MODE) is True
    assert yield_enhancement_mode_uses_short_vol(YIELD_ENHANCEMENT_INCOME_UPSIDE_MODE) is False
...
def test_yield_enhancement_position_role_does_not_treat_any_grouped_put_as_yield_enhancement() -> None:
    ...
    assert role.is_yield_enhancement_short_put is False


def test_yield_enhancement_position_role_identifies_grouped_sell_put_leg() -> None:
    role = resolve_yield_enhancement_position_role(
        {
            "symbol": "NVDA",
            "option_type": "put",
