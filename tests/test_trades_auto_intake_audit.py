...
def test_build_audit_event_promotes_missing_account_mapping_diagnostics() -> None:
    deal = NormalizedTradeDeal(
        ...
        currency="HKD",
        trade_time_ms=1000,
        raw_payload={"deal_id": "deal-2", "trade_acc_id": "REDACTED_FUTU_ACCOUNT"},
    ...
    event = build_trade_intake_audit_event(
        ...
        result={
            "status": "unresolved",
            "action": None,
            "reason": "missing_account_mapping:futu_account_id=REDACTED_FUTU_ACCOUNT",
            "deal_id": "deal-2",
            "account": None,
            "operations": [],
            "diagnostics": {
    ...
    assert event["futu_account_id"] == "REDACTED_FUTU_ACCOUNT"
