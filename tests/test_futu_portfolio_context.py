...
def test_fetch_futu_portfolio_context_filters_rows_by_mapped_account_ids() -> None:
    ...
    class _FakeGateway:
        ...
        def get_account_balance(self, **kwargs):
            ...
            if acc_id == "REDACTED_FUTU_ACCOUNT":
                return [
    ...
    assert fake_gateway.balance_calls == ["REDACTED_FUTU_ACCOUNT"]
    assert fake_gateway.position_calls == ["REDACTED_FUTU_ACCOUNT"]
