...
# Offline fixture/measurement primitives are shared with the slice-2 current
# decision benchmark. The underscore-prefixed names are deliberately reused
# across the two benchmark scripts; `scripts.benchmark_support` owns them.
from scripts.benchmark_support import (
    FIXTURE_SCHEMA,
    MAX_ACCOUNTS,
    MAX_CURRENT_STATE_LOTS,
    MAX_HISTORY_EVENTS,
    MAX_PAYLOAD_BYTES,
    MIN_PAYLOAD_BYTES,
    ...
    _event_payload_metrics,
    _events_sha256,
    _git_sha,
    _host_profile,
    _insert_phase_3a_events,
    _phase_3a_tail_events,
    _scenario_spec,
    _sha256_json,
    _sqlite_sizes,
    _temporary_phase_3a_base,
