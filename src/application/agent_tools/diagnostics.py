...
_HEALTHCHECK_OUTPUT_CONTRACT: dict[str, Any] = {
    ...
    "fact_fields": [
        ...
        "summary.wheel_activation_monitoring_gate",
        "summary.wheel_activation_reason_code",
        "summary.wheel_activation_enabled_account_count",
        "wheel_activation_readiness.monitoring_gate",
        "wheel_activation_readiness.reason_code",
        "wheel_activation_readiness.enabled_account_count",
        "wheel_activation_readiness.remediation_command",
        "wheel_activation_readiness.accounts[].policy_drift",
        "wheel_activation_readiness.accounts[].remediation_command",
        "checks[].name",
        "checks[].status",
        "checks[].message",
