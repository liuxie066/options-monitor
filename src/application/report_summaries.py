...
SELL_PUT_EMPTY_FIELDS = {
    ...
    'linked_call_net_credit_yield': None,
    'linked_call_annualized_net_credit_yield': None,
    ...
    'linked_call_cost_to_put_credit': None,
    'linked_call_upside_lift': None,
    'linked_call_upside_lift_to_call_cost': None,
    'linked_call_upside_lift_to_put_credit': None,
    'linked_call_premium_funding_score': None,
}
...
def _sell_put_extras(df: pd.DataFrame, top: pd.Series) -> dict[str, Any]:
    return {
        ...
        'realized_volatility_estimate': _safe_float(top.get('realized_volatility_estimate')),
        ...
        'linked_call_net_credit_yield': _safe_float(top.get('linked_call_net_credit_yield')),
        'linked_call_annualized_net_credit_yield': _safe_float(top.get('linked_call_annualized_net_credit_yield')),
        ...
        'linked_call_cost_to_put_credit': _safe_float(top.get('linked_call_cost_to_put_credit')),
        'linked_call_upside_lift': _safe_float(top.get('linked_call_upside_lift')),
        'linked_call_upside_lift_to_call_cost': _safe_float(top.get('linked_call_upside_lift_to_call_cost')),
        'linked_call_upside_lift_to_put_credit': _safe_float(top.get('linked_call_upside_lift_to_put_credit')),
        'linked_call_premium_funding_score': _safe_float(top.get('linked_call_premium_funding_score')),
    }
