...
TASK_PROFILES: tuple[TaskProfile, ...] = (
    ...
    TaskProfile(
        ...
        trigger_terms=("收益", "收入", "权利金", "已实现", "主要来自", "来源", "组成", "构成", "账户表现", "表现更好"),
    ...
    TaskProfile(
        ...
        task_modes=("diagnose", "analyze", "recommend", "explain"),
        trigger_terms=("候选", "过滤", "没通过", "没出", "参数", "策略", "太严"),
    ...
    TaskProfile(
        ...
        trigger_terms=("健康", "状态", "扫描", "通知", "推送", "线上", "运行"),
