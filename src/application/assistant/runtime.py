...
from src.application.assistant.agent_loop import build_tool_observation, run_read_only_agent_loop
...
def handle_assistant_message(
    ...
    *,
    ...
    def _parse(text: str, parser_now_fn: Callable[[], date] | None) -> AssistantIntent:
...
def _ensure_llm_intent_allowed(intent: AssistantIntent) -> None:
