...
This package only hosts shared utilities (notify format, opend guard, project
guard, required-data prefetch, misc). It is intentionally NOT
...
Submodules are imported lazily by consumers (``from .notify_format import ...``)
