...
- [Strategy Lab Current Implementation](STRATEGY_LAB_DESIGN.md)：Phase 2 Slice 1 基础切换、当前唯一入口和待实现产品面。
...
- [Strategy Lab Experiment Platform System Design](STRATEGY_LAB_EXPERIMENT_PLATFORM_SYSTEM_DESIGN.md)：目标技术架构、当前 Phase 2 状态、函数清单、复用和删除边界。
