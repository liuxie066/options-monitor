...
- `assistant_agent_eval` 已扩展为 36 条 fixture，新增覆盖升级状态问题触发一次只读
...
| Gate | 命令 | 通过证据 | 失败回退 |
|---|---|---|---|
| fixture 格式 | `jq -c . tests/fixtures/assistant_agent_eval.jsonl` | 36 条 JSONL 都能逐行解析 | 停止发布，先修 fixture；不要删除失败样本 |
