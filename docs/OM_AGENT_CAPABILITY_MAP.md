...
| "What is my assigned-stock holding PnL?" | `option_positions_read action=assigned-stock refresh_quotes=true` | User asks to record a sale/repair or override a quote | Rows show assigned-stock cost basis, spot/quote status, realized/unrealized stock PnL, and lifecycle PnL |
