...
- Python files scanned: 1036 (`src`: 526, `domain`: 82, `scripts`: 11, `tests`: 417)
- Internal import edges: 7445 total, 3048 production/script edges excluding tests
- Parse errors: 0
