...
- Python files scanned: 1038 (`src`: 527, `domain`: 82, `scripts`: 11, `tests`: 418)
- Internal import edges: 7465 total, 3054 production/script edges excluding tests
- Parse errors: 0
