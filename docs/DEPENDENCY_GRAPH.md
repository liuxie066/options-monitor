...
- Python files scanned: 916 (`src`: 491, `domain`: 75, `scripts`: 8, `tests`: 342)
- Internal import edges: 5865 total, 2492 production/script edges excluding tests
- Parse errors: 0
