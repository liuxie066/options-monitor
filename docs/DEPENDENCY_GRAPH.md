...
- Python files scanned: 1063 (`src`: 533, `domain`: 87, `scripts`: 13, `tests`: 430)
- Internal import edges: 7364 total, 3285 production/script edges excluding tests
- Parse errors: 0
