...
- Python files scanned: 1041 (`src`: 528, `domain`: 82, `scripts`: 11, `tests`: 420)
- Internal import edges: 7491 total, 3058 production/script edges excluding tests
- Parse errors: 0
