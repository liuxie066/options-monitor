...
- Python files scanned: 747 (`src`: 410, `domain`: 63, `scripts`: 7, `tests`: 267)
- Internal import edges: 4370 total, 1938 production/script edges excluding tests
- Parse errors: 0
...
| src.infrastructure.exchange_rates | 19 |
