...
- Python files scanned: 680 (`src`: 397, `domain`: 52, `scripts`: 7, `tests`: 224)
- Internal import edges: 3620 total, 1696 production/script edges excluding tests
- Parse errors: 0
...
| src.application.assistant.agent_loop | 24 |
