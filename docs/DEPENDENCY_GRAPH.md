...
- Python files scanned: 735 (`src`: 406, `domain`: 62, `scripts`: 7, `tests`: 260)
- Internal import edges: 4127 total, 1920 production/script edges excluding tests
- Parse errors: 0
