...
- Python files scanned: 692 (`src`: 405, `domain`: 52, `scripts`: 7, `tests`: 228)
- Internal import edges: 3621 total, 1709 production/script edges excluding tests
- Parse errors: 0
