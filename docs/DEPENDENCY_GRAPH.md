...
- Internal import edges: 2722 total, 1225 production/script edges excluding tests
- Parse errors: 0
...
| src.application | src.infrastructure | 72 |
...
|---|---|
| src.application.agent_tool_contracts | 50 |
