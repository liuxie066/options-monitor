...
- Internal import edges: 7073 total, 3165 production/script edges excluding tests
- Parse errors: 0
...
| src.application.ledger | domain.domain | 102 |
| src.application.ledger | domain.domain.ledger | 54 |
...
| domain.domain | domain.domain.ledger | 18 |
...
| domain.domain.trade_contract_identity | 33 |
