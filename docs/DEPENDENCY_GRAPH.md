...
- Python files scanned: 675 (`src`: 389, `domain`: 52, `scripts`: 7, `tests`: 227)
- Internal import edges: 3789 total, 1790 production/script edges excluding tests
- Parse errors: 0
