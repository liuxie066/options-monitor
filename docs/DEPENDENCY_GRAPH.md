...
- Internal import edges: 7440 total, 3302 production/script edges excluding tests
- Parse errors: 0
...
flowchart LR
  ...
  application -->|161| infrastructure
...
| application | infrastructure | 161 |
