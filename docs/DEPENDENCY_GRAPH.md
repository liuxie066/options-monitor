...
- Python files scanned: 955 (`src`: 510, `domain`: 76, `scripts`: 8, `tests`: 361)
- Internal import edges: 6013 total, 2573 production/script edges excluding tests
- Parse errors: 0
