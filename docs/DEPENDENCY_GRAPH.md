...
- Python files scanned: 589 (`src`: 320, `domain`: 51, `scripts`: 7, `tests`: 211)
- Internal import edges: 3044 total, 1416 production/script edges excluding tests
- Parse errors: 0
...
| from | to | imports |
|---|---|---|
| tests | application | 1070 |
| tests | domain | 267 |
| tests | interfaces | 146 |
