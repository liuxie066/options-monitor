...
- Python files scanned: 974 (`src`: 522, `domain`: 75, `scripts`: 13, `tests`: 364)
- Internal import edges: 6455 total, 2776 production/script edges excluding tests
- Parse errors: 0
