...
- Python files scanned: 1074 (`src`: 536, `domain`: 87, `scripts`: 14, `tests`: 437)
- Internal import edges: 7554 total, 3326 production/script edges excluding tests
- Parse errors: 0
