...
- Python files scanned: 1035 (`src`: 526, `domain`: 82, `scripts`: 11, `tests`: 416)
- Internal import edges: 7492 total, 3027 production/script edges excluding tests
- Parse errors: 0
