...
- Python files scanned: 1003 (`src`: 533, `domain`: 76, `scripts`: 13, `tests`: 381)
- Internal import edges: 6795 total, 2914 production/script edges excluding tests
- Parse errors: 0
