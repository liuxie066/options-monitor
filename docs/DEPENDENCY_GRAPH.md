...
- Python files scanned: 918 (`src`: 494, `domain`: 76, `scripts`: 8, `tests`: 340)
- Internal import edges: 5797 total, 2494 production/script edges excluding tests
- Parse errors: 0
...
flowchart LR
  ...
  storage -->|1| domain
  tests -->|2406| application
  tests -->|482| domain
  tests -->|2| domain_services
  tests -->|138| infrastructure
...
| from | to | imports |
|---|---|---|
| tests | application | 2406 |
| tests | domain | 482 |
| tests | interfaces | 216 |
| tests | infrastructure | 138 |
| tests | storage | 16 |
| tests | scripts | 13 |
...
| src.application | src.infrastructure | 99 |
...
| src.application.trades | src.application | 19 |
...
| src.application.account_config | 37 |
...
| src.application.pipeline_runtime | 21 |
