...
- Python files scanned: 1002 (`src`: 532, `domain`: 76, `scripts`: 13, `tests`: 381)
- Internal import edges: 6804 total, 2905 production/script edges excluding tests
- Parse errors: 0
