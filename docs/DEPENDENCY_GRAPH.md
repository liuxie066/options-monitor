...
- Python files scanned: 516 (`src`: 264, `domain`: 49, `scripts`: 7, `tests`: 196)
- Internal import edges: 2496 total, 1111 production/script edges excluding tests
- Parse errors: 0
