...
- Python files scanned: 692 (`src`: 400, `domain`: 52, `scripts`: 8, `tests`: 232)
- Internal import edges: 3668 total, 1692 production/script edges excluding tests
- Parse errors: 0
