...
- Python files scanned: 556 (`src`: 291, `domain`: 51, `scripts`: 6, `tests`: 208)
- Internal import edges: 2883 total, 1317 production/script edges excluding tests
- Parse errors: 0
...
| from | to | imports |
|---|---|---|
| src.application | domain.domain | 101 |
