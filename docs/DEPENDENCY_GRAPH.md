...
- Python files scanned: 939 (`src`: 506, `domain`: 75, `scripts`: 9, `tests`: 349)
- Internal import edges: 6124 total, 2593 production/script edges excluding tests
- Parse errors: 0
