...
- Python files scanned: 521 (`src`: 269, `domain`: 49, `scripts`: 6, `tests`: 197)
- Internal import edges: 2573 total, 1169 production/script edges excluding tests
- Parse errors: 0
...
| src.application | src.infrastructure | 67 |
