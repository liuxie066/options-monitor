...
- Python files scanned: 907 (`src`: 489, `domain`: 73, `scripts`: 9, `tests`: 336)
- Internal import edges: 5923 total, 2461 production/script edges excluding tests
- Parse errors: 0
