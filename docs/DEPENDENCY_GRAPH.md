...
- Python files scanned: 908 (`src`: 489, `domain`: 73, `scripts`: 9, `tests`: 337)
- Internal import edges: 5931 total, 2465 production/script edges excluding tests
- Parse errors: 0
