...
- Python files scanned: 901 (`src`: 487, `domain`: 73, `scripts`: 8, `tests`: 333)
- Internal import edges: 5896 total, 2450 production/script edges excluding tests
- Parse errors: 0
