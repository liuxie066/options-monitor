...
- Python files scanned: 903 (`src`: 492, `domain`: 76, `scripts`: 8, `tests`: 327)
- Internal import edges: 5510 total, 2456 production/script edges excluding tests
- Parse errors: 0
