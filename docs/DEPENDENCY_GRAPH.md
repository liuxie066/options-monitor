...
- Python files scanned: 976 (`src`: 521, `domain`: 75, `scripts`: 13, `tests`: 367)
- Internal import edges: 6511 total, 2788 production/script edges excluding tests
- Parse errors: 0
