...
- Python files scanned: 972 (`src`: 521, `domain`: 75, `scripts`: 13, `tests`: 363)
- Internal import edges: 6442 total, 2771 production/script edges excluding tests
- Parse errors: 0
