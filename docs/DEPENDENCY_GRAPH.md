...
- Python files scanned: 710 (`src`: 422, `domain`: 52, `scripts`: 7, `tests`: 229)
- Internal import edges: 3711 total, 1751 production/script edges excluding tests
- Parse errors: 0
