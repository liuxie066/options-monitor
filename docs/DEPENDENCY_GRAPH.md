...
- Python files scanned: 872 (`src`: 476, `domain`: 73, `scripts`: 8, `tests`: 315)
- Internal import edges: 5184 total, 2325 production/script edges excluding tests
- Parse errors: 0
...
| src.application.close_advice_runner | 25 |
