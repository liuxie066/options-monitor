...
- Python files scanned: 962 (`src`: 518, `domain`: 75, `scripts`: 11, `tests`: 358)
- Internal import edges: 6388 total, 2747 production/script edges excluding tests
- Parse errors: 0
