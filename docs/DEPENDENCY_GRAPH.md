...
- Python files scanned: 590 (`src`: 320, `domain`: 51, `scripts`: 7, `tests`: 212)
- Internal import edges: 3057 total, 1416 production/script edges excluding tests
- Parse errors: 0
