...
- Python files scanned: 711 (`src`: 414, `domain`: 52, `scripts`: 7, `tests`: 238)
- Internal import edges: 3794 total, 1784 production/script edges excluding tests
- Parse errors: 0
...
|---|---|
| src.application.assistant.agent_loop | 33 |
