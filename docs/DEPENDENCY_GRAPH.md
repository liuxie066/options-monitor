...
- Python files scanned: 912 (`src`: 491, `domain`: 74, `scripts`: 9, `tests`: 338)
- Internal import edges: 5944 total, 2472 production/script edges excluding tests
- Parse errors: 0
