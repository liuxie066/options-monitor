...
- Python files scanned: 930 (`src`: 505, `domain`: 73, `scripts`: 8, `tests`: 344)
- Internal import edges: 5957 total, 2521 production/script edges excluding tests
- Parse errors: 0
