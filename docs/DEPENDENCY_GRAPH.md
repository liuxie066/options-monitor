...
- Python files scanned: 741 (`src`: 407, `domain`: 63, `scripts`: 7, `tests`: 264)
- Internal import edges: 4270 total, 1933 production/script edges excluding tests
- Parse errors: 0
...
| from | to | imports |
|---|---|---|
| src.application | domain.domain | 165 |
