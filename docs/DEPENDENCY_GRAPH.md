...
- Python files scanned: 1033 (`src`: 524, `domain`: 82, `scripts`: 11, `tests`: 416)
- Internal import edges: 7415 total, 3031 production/script edges excluding tests
- Parse errors: 0
