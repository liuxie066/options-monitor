...
- Python files scanned: 599 (`src`: 325, `domain`: 51, `scripts`: 7, `tests`: 216)
- Internal import edges: 3121 total, 1441 production/script edges excluding tests
- Parse errors: 0
