...
- Python files scanned: 707 (`src`: 412, `domain`: 52, `scripts`: 7, `tests`: 236)
- Internal import edges: 3722 total, 1765 production/script edges excluding tests
- Parse errors: 0
