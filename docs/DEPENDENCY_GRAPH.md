...
- Python files scanned: 649 (`src`: 370, `domain`: 52, `scripts`: 7, `tests`: 220)
- Internal import edges: 3449 total, 1614 production/script edges excluding tests
- Parse errors: 0
