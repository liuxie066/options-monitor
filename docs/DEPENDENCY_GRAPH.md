...
- Python files scanned: 919 (`src`: 493, `domain`: 75, `scripts`: 9, `tests`: 342)
- Internal import edges: 5984 total, 2496 production/script edges excluding tests
- Parse errors: 0
