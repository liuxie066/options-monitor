...
- Python files scanned: 1004 (`src`: 533, `domain`: 76, `scripts`: 13, `tests`: 382)
- Internal import edges: 6825 total, 2918 production/script edges excluding tests
- Parse errors: 0
