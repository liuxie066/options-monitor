...
- Python files scanned: 920 (`src`: 493, `domain`: 75, `scripts`: 9, `tests`: 343)
- Internal import edges: 5992 total, 2500 production/script edges excluding tests
- Parse errors: 0
