...
- Python files scanned: 1046 (`src`: 528, `domain`: 87, `scripts`: 12, `tests`: 419)
- Internal import edges: 6993 total, 3141 production/script edges excluding tests
- Parse errors: 0
