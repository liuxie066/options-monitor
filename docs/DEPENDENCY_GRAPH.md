...
- Python files scanned: 924 (`src`: 495, `domain`: 75, `scripts`: 9, `tests`: 345)
- Internal import edges: 6000 total, 2503 production/script edges excluding tests
- Parse errors: 0
