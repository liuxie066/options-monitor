...
- Python files scanned: 678 (`src`: 395, `domain`: 52, `scripts`: 7, `tests`: 224)
- Internal import edges: 3614 total, 1692 production/script edges excluding tests
- Parse errors: 0
