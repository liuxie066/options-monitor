...
- Python files scanned: 1049 (`src`: 529, `domain`: 87, `scripts`: 12, `tests`: 421)
- Internal import edges: 7052 total, 3158 production/script edges excluding tests
- Parse errors: 0
...
| src.application.ledger | domain.domain | 99 |
