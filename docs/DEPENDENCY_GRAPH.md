...
- Python files scanned: 696 (`src`: 403, `domain`: 52, `scripts`: 8, `tests`: 233)
- Internal import edges: 3758 total, 1729 production/script edges excluding tests
- Parse errors: 0
...
| from | to | imports |
|---|---|---|
| src.application | domain.domain | 132 |
