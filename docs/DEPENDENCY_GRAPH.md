...
- Python files scanned: 1015 (`src`: 543, `domain`: 76, `scripts`: 12, `tests`: 384)
- Internal import edges: 6743 total, 2937 production/script edges excluding tests
- Parse errors: 0
