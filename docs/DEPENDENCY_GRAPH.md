...
- Python files scanned: 755 (`src`: 413, `domain`: 63, `scripts`: 7, `tests`: 272)
- Internal import edges: 4407 total, 1952 production/script edges excluding tests
- Parse errors: 0
