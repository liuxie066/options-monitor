...
- Python files scanned: 541 (`src`: 278, `domain`: 51, `scripts`: 6, `tests`: 206)
- Internal import edges: 2728 total, 1236 production/script edges excluding tests
- Parse errors: 0
