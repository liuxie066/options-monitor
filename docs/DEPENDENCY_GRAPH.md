...
- Python files scanned: 692 (`src`: 402, `domain`: 52, `scripts`: 7, `tests`: 231)
- Internal import edges: 3695 total, 1730 production/script edges excluding tests
- Parse errors: 0
...
|---|---|
| src.application.agent_tool_contracts | 86 |
