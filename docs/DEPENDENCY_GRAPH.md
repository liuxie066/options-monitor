...
- Internal import edges: 3360 total, 1566 production/script edges excluding tests
- Parse errors: 0
...
| from | to | imports |
|---|---|---|
| tests | application | 1206 |
| tests | domain | 282 |
| tests | interfaces | 165 |
