...
- Python files scanned: 740 (`src`: 407, `domain`: 63, `scripts`: 7, `tests`: 263)
- Internal import edges: 4217 total, 1930 production/script edges excluding tests
- Parse errors: 0
...
| from | to | imports |
|---|---|---|
| src.application | domain.domain | 164 |
