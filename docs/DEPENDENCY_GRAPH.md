...
- Python files scanned: 538 (`src`: 276, `domain`: 51, `scripts`: 6, `tests`: 205)
- Internal import edges: 2713 total, 1226 production/script edges excluding tests
- Parse errors: 0
...
| from | to | imports |
|---|---|---|
| src.application | domain.domain | 95 |
