...
- Python files scanned: 736 (`src`: 406, `domain`: 62, `scripts`: 7, `tests`: 261)
- Internal import edges: 4146 total, 1920 production/script edges excluding tests
- Parse errors: 0
