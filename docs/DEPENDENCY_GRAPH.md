...
- Python files scanned: 1051 (`src`: 529, `domain`: 87, `scripts`: 13, `tests`: 422)
- Internal import edges: 7065 total, 3162 production/script edges excluding tests
- Parse errors: 0
