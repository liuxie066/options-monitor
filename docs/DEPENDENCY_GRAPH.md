...
- Internal import edges: 7067 total, 2918 production/script edges excluding tests
- Parse errors: 0
...
| src.application | src.application.research | 5 |
